...
PICS = (environ.get('PICS', 'https://iili.io/2rCQZpn.jpg https://iili.io/2UzdkkQ.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://iili.io/2iBGyfs.jpg https://iili.io/2iBGjlj.jpg')).split()  # Fsub pic
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002358948340').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/hFmm5F4B/file-1174.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'harishbharath89@oksbi')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://telegram.me/Harishrc200')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://telegram.me/moviessfileupdate')
